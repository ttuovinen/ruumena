...
function App() {
  ...
  const [removeN, setRemoveN] = React.useState(3)
  const [removeOffset, setRemoveOffset] = React.useState(3)
  const [removePercent, setRemovePercent] = React.useState(33)
  ...
  const getRemoveTools = () => (
    <>
      <div className="button-wrapper">
        <div className="button-wrapper">
          <button onClick={removeRandom}>Poista satunnaisesti</button>
          <input
            type="range"
            name="percent"
            min="1"
        ...
        <button onClick={removeConstant}>Poista säännöllisesti</button>
        joka
        <input
          type="range"
          name="step"
